""" The ego vehicle is driving on a straight road; the adversarial pedestrian is hidden behind a vending machine on the right front, and abruptly dashes out onto the road, and stops directly in the path of the ego vehicle.
"""
...
Blocker = VendingMachine right of IntSpawnPt by globalParameters.OPT_GEO_BLOCKER_X_DISTANCE,
