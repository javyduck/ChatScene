...
#         }
        batch = {
            'act': np.stack(action)[sample_index],# action
            'obs': np.stack(prepared_obs)[sample_index, :],         # state
            'obs_next': np.stack(prepared_next_obs)[sample_index, :],  # next state
            'rew': np.stack(prepared_rewards)[sample_index],       # reward
            'done': np.stack(prepared_dones)[sample_index],           # done
        }
